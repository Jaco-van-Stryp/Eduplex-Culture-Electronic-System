...
public class MainAddStudentName extends javax.swing.JFrame {
    ...
    private void btnVote7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVote7ActionPerformed
        if (sName.getText().equalsIgnoreCase("")) {
            ...
            try {
                PrintWriter printer = new PrintWriter(new FileWriter(cm.getLocalStorageLocation() + "\\Culture_Management_System\\" + "Student_Name.db"));

                printer.println(sName.getText());
                printer.close();
                new EventSelection().setVisible(true);
                this.dispose();
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Please Contact A Teacher, Something Went Wrong", "Warning", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
            }
